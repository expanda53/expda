...
if (dialogres=="null") then
    ...
    ui:showDialog("Kiválasztott bizonylat: " .. mibiz .. "\ncég: " .. cegnev .. "\nIndítható az ellenörzés?","ellenor/mibizlist_click.lua igen " .. azon,"ellenor/mibizlist_click.lua nem")
end
if (dialogres=="igen") then
    kezelo = ui:getKezelo()
    azon = params[3]    
    kulsoraktar = ui:getGlobal("kulsoraktar")
    str = 'ellenor_init '..azon..' '..kezelo.. ' ' .. kulsoraktar
    ...
    if (q[1]['RESULT']~='0') then
        ...
        ui:executeCommand('showobj','pfooter;button_review;cap_ean;eean;button_cikkval','')
